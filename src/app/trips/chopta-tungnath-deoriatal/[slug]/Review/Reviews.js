...
export default function Reviews() {
    ...
    return (
        ...
        >
            ...
            <h4 className="text-[20px] md:text-[22px] lg:text-[24px] font-medium text-[#200f0d] mb-4 tracking-normal">Reviews</h4>
                        ...
                        <div className="flex items-center justify-between mb-[15px]">
                            <div className="flex items-center gap-3">
                                ...
                                <div className="flex flex-col">
                                    <h6 className="text-[11px] md:text-[17px] lg:text-[18px] font-semibold text-[#200f0d] mb-1 leading-tight">{review.name}</h6>
                                    <span className="text-[11px] text-gray-500 m-0">
                            ...
                            <div className="flex items-center gap-0.5 ">
                                {[...Array(5)].map((_, i) => (
                                    <svg key={i} className="w-4 h-4 md:w-6.5 md:h-6.5 text-[#e5be37]" fill="currentColor" viewBox="0 0 20 20">
