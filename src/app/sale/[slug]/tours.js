...
const TourCard = ({ tour }) => {
    return (
        <div className="flex-shrink-0 w-[305px] h-[400px] relative rounded-[16px] overflow-hidden shadow-[rgba(99,99,99,0.2)_0px_2px_8px_0px] transition-all duration-400 group">
            <a href={tour.link} className="block h-full relative border-none!">
                ...
                <div className="relative h-full rounded-[16px] overflow-hidden">
                    ...
                    {/* Badges Container */}
                    <div className="absolute top-[5%] left-0 w-full z-[2]">
                        <span className="inline-block text-white px-[14px] py-[6px] rounded-r-[4px] text-[11px] font-bold uppercase tracking-[0.8px] shadow-[0_4px_12px_rgba(39,85,176,0.4)] bg-gradient-to-r from-[#ff3532] via-[#ff6640] to-[#ff8b4b]">
                            Discount: ₹{tour.discount} OFF
                        </span>
                        <span className="absolute bottom-[-14%] right-[5%] bg-[#fff500] text-black px-[8px] py-[6px] rounded-[8px] text-[12px] font-semibold backdrop-blur-[10px] border border-white/30 translate-y-[200px]">
                            {tour.duration}
                        </span>
                    </div>
                </div>
                ...
                <div className="absolute bottom-0 left-0 w-full p-[80px_20px_20px] bg-gradient-to-t from-black to-transparent z-[3]">
                    <h5 className="text-[16px] font-medium text-white mb-2 leading-[1.2] transition-colors group-hover:text-[#fff500]">
                        {tour.title}
                    </h5>

                    <div className="flex justify-between items-center">
                        <div className="text-white text-[14px] leading-[15px]">
                            <span className="font-bold">₹{tour.currentPrice}</span>
                            <span className="text-[11px] text-[#eee] line-through ml-1">₹{tour.originalPrice}</span>
                            <em className="block text-[9px] font-medium not-italic text-[#eee]">per person</em>
                        </div>

                        <div className="flex items-center gap-1">
                            <div className="w-8 h-8 rounded-full border border-white flex items-center justify-center transition-colors group-hover:bg-white group-hover:text-black">
                                <i className="bi bi-chevron-right text-[12px]"></i>
                            </div>
                            <span className="bg-white text-black text-[12px] font-semibold px-[6px] py-[5px] rounded-[6px] border border-white">
                                Trip Details
                            </span>
                        </div>
                    </div>
    ...
    return (
        <div className="mt-12">
            ...
            <div className="relative overflow-hidden">
                <div
                    ref={scrollRef}
                    className="flex gap-[17px] overflow-x-auto no-scrollbar scroll-smooth snap-x touch-pan-x pb-4"
                >
