...
>>>>>>> ce4aa747acdca4b41b7d429173de79543e028739
...
>>>>>>> ce4aa747acdca4b41b7d429173de79543e028739
      ...
      {/* ===== MOBILE DRAWER ===== */}
      <div
        className={`fixed top-0 left-0 w-full h-full bg-white z-[100] overflow-y-auto transform transition-transform duration-300 ${isOpen ? "translate-x-0" : "-translate-x-full"
          } md:hidden`}
      >
        <div className="p-6">
