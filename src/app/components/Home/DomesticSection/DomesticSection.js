    ...
    <div className="p-6 md:p-10 pb-0">
      <div className="flex flex-col md:flex-row justify-between items-center md:items-end gap-4">
        ...
        <div className="hidden md:flex gap-3 mb-1">
          <button className="Domestic-swiper-prev bg-[#2556B0] w-8 h-8 rounded-full flex items-center justify-center text-white">
            <IoIosArrowBack size={20} />
          </button>
          <button className="Domestic-swiper-next bg-[#2556B0] w-8 h-8 rounded-full flex items-center justify-center text-white">
